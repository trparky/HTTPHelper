...
Public Class Form1
    ...
    Private Sub btnDownloadFile_Click(sender As Object, e As EventArgs) Handles btnDownloadFile.Click
        ...
        downloadThread = New Threading.Thread(Sub()
                                                  Dim urlToFileToBeDownloaded As String = "https://www.toms-world.org/Install%20Restore%20Point%20Creator.exe"
                                                  Dim pathToDownloadFileTo As String = "S:\Install Restore Point Creator.exe"
